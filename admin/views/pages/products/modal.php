                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" id="productDiscount" name="discount" min="0" max="100" step="1">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-center mt-3">
                            <img id="currentProductImage" src="" class="img-thumbnail shadow-sm" style="max-width:120px; display:none;">
                            <div class="form-text mt-1" id="imageHelpText">
                                Bắt buộc khi thêm mới, để trống nếu không thay đổi hình ảnh khi sửa.
                            </div>
                        </div>
                    </div>
                </div>
