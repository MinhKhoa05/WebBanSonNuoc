        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-body">
                        <h5 class="mb-3">Nhập mã giảm giá</h5>
                        <div class="d-flex">
                            <input type="text" class="form-control shadow-sm" id="discount-code" placeholder="Nhập mã giảm giá">
                            <button class="btn btn-primary ms-2" id="apply-discount">Áp dụng</button>
                        </div>
                ...
                <div class="card cart-total shadow-lg border-0">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold fs-5 text-danger" id="total">3.022.500đ</span>
                        </div>
