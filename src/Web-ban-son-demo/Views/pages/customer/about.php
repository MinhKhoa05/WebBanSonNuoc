...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="ms-lg-4">
                        ...
                        <p class="text-muted">Được thành lập vào năm 2005, ColorHomes Paint bắt đầu là một xưởng sản xuất sơn nhỏ với mục tiêu cung cấp các sản phẩm sơn chất lượng cao với giá cả hợp lý cho người tiêu dùng Việt Nam.</p>
                        <p class="text-muted">Trải qua hơn 20 năm phát triển, chúng tôi đã trở thành một trong những thương hiệu sơn nước hàng đầu, được tin dùng bởi hàng nghìn khách hàng và đối tác xây dựng trên khắp cả nước.</p>
            ...
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="text-center px-4">
                        <div class="bg-white text-paint-primary rounded-circle d-inline-flex align-items-center justify-content-center mb-4" style="width: 80px; height: 80px;">
                            <i class="bi bi-heart-fill fs-1"></i>
                        </div>
                        <h3 class="h4 mb-3">Sứ mệnh</h3>
                        <p class="opacity-75">Cung cấp các sản phẩm sơn chất lượng cao, an toàn và thân thiện với môi trường, giúp bảo vệ và làm đẹp không gian sống của khách hàng.</p>
                    </div>
                </div>
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="text-center px-4">
                        ...
                        <p class="opacity-75">Chất lượng, Đổi mới, Trách nhiệm và Khách hàng là trọng tâm trong mọi hoạt động của chúng tôi.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="text-center px-4">
                        ...
                        <p class="opacity-75">Trở thành thương hiệu sơn số 1 Việt Nam về chất lượng và dịch vụ, mở rộng thị trường ra khu vực Đông Nam Á.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted small">Sản phẩm đạt các tiêu chuẩn quốc tế về độ bền và an toàn.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted small">Hơn 1000 màu sắc khác nhau, đáp ứng mọi nhu cầu thiết kế.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted small">Sản phẩm có hàm lượng VOC thấp, an toàn cho sức khỏe.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text text-muted small">Đội ngũ tư vấn chuyên nghiệp, sẵn sàng hỗ trợ mọi lúc.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text small text-muted">Tiến sĩ Hóa học, chuyên gia về công nghệ sơn hiện đại.</p>
                        </div>
                        <div class="card-footer bg-white border-0 text-center">
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-linkedin"></i></a>
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-envelope"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text small text-muted">Chuyên gia về xây dựng thương hiệu và chiến lược phát triển thị trường.</p>
                        </div>
                        <div class="card-footer bg-white border-0 text-center">
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-linkedin"></i></a>
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-envelope"></i></a>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text small text-muted">15 năm kinh nghiệm trong phát triển hệ thống phân phối sơn toàn quốc.</p>
                        </div>
                        <div class="card-footer bg-white border-0 text-center">
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-linkedin"></i></a>
                            <a href="#" class="btn btn-sm btn-light mx-1"><i class="bi bi-envelope"></i></a>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        <div class="me-3">
                                            <div class="bg-paint-primary text-white rounded-circle d-flex align-items-center justify-content-center fw-bold" style="width: 50px; height: 50px;">
                                                2005
                                            </div>
                                        </div>
                                        <div>
                                            <h4 class="h5 mb-2">Thành lập công ty</h4>
                                            <p class="text-muted small mb-0">Xưởng sản xuất đầu tiên được thành lập tại Hà Nội với 15 nhân viên.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Khánh thành nhà máy sản xuất 5,000m² tại Khu công nghiệp Bắc Ninh.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Đạt chứng nhận ISO 9001:2015 và ISO 14001:2015 về hệ thống quản lý chất lượng và môi trường.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Bắt đầu xuất khẩu sản phẩm sang thị trường Đông Nam Á và đạt doanh thu 100 tỷ đồng.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Khánh thành nhà máy thông minh đầu tiên với dây chuyền sản xuất tự động hóa hoàn toàn.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Mục tiêu phát triển 500 điểm bán hàng trên toàn quốc và đạt doanh thu 500 tỷ đồng.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="py-5 paint-gradient">
        <div class="container text-center text-white py-4">
            ...
            <p class="lead mb-4">Hãy liên hệ với chúng tôi ngay hôm nay để được tư vấn miễn phí về giải pháp sơn phù hợp nhất.</p>
