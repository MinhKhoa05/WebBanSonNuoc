    ...
    <section class="py-5">
        <div class="container py-4 lazy-load">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow h-100">
                        <img src="customer/views/assets/images/Ayaka.jpeg" class="card-img-top" alt="Technical Director">
                        <div class="card-body text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow h-100">
                        <img src="customer/views/assets/images/Neuvillete.jpeg" class="card-img-top" alt="Marketing Director">
                        <div class="card-body text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card border-0 shadow h-100">
                        <img src="customer/views/assets/images/Kaveh.jpeg" class="card-img-top" alt="Sales Director">
                        <div class="card-body text-center">
