                        ...
                        <div class="comments-section mt-5">
                            ...
                            <div class="comment-item d-flex mb-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-1">Bài viết rất hay và chi tiết. Tôi đã áp dụng thành công cho căn nhà của
                                        mình. Cảm ơn tác giả!</p>
                            ...
                            <div class="comment-item d-flex mb-4">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="comment-reply ms-5 mt-3 d-flex">
                                        <img src="/api/placeholder/50/50" alt="Admin" class="comment-avatar me-3"
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-1">Chào bạn, loại sơn này có thể sử dụng cho cả nội thất và ngoại
                                                thất. Tuy nhiên, với ngoại thất bạn nên chọn dòng chuyên dụng để đảm bảo độ
                                                bền màu.</p>
                                            <button class="btn btn-sm btn-light">Trả lời</button>
                                        </div>
                                    </div>
                            ...
                            <div class="comment-item d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-1">Cần tư vấn thêm về giá cả và địa chỉ mua sản phẩm thì liên hệ theo số
                                        nào vậy admin?</p>
                                    <button class="btn btn-sm btn-light">Trả lời</button>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                                ...
                                foreach ($popular_posts as $pop_post):
                                    ...
                                    <div class="d-flex mb-3">
                                        <img src="../../../uploads/<?= htmlspecialchars($pop_post['thumbnail']) ?>"
                                            alt="<?= htmlspecialchars($pop_post['title']) ?>" class="rounded"
                                            style="width: 70px; height: 70px; object-fit: cover;">
                                        <div class="ms-3">
                                            <a href="post.php?id=<?= $pop_post['id'] ?>"
                        ...
                        <div class="card mb-4 shadow-sm">
                            <div class="card-body">
                                ...
                                <div>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn
                                        nước</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn
                                        dầu</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn
                                    ...
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn
                                        chống thấm</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn nội
                                        thất</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Sơn
                                        ngoại thất</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Màu
                                        sắc</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Không
                                        gian</a>
                                    <a href="#" class="badge bg-light text-dark text-decoration-none mb-2 me-2 p-2">Trang
                                        trí</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card related-post-card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="post.php?id=<?= $rel_post['id'] ?>" class="btn btn-sm btn-outline-primary">Đọc
                                            tiếp</a>
                                    </div>
